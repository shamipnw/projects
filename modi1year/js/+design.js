$(document).ready(function () {
	...
	(function () {
		...
		// 	var container = $('nav#nmAnniversary_nav');

		// 	if (!container.is(e.target) && container.has(e.target).length === 0) {
		// 		$('nav#nmAnniversary_nav').slideUp(150, 'easeOutCirc', function () {
		// 			$('a.nav_btn').removeClass('nav_btn_hover');
		// 			$('a.nav_btn').removeClass('closeNav');
		// 		});
		// 	}
		// });
	}) ();
	...
	(function () {
		$('.page_content_item_alt').find('span.circle_content').hover(function () {
			$(this).children('section.page_content_item_share').fadeIn(600, 'easeOutSine');
		}, function () {
			$(this).children('section.page_content_item_share').fadeOut(300, 'easeOutCirc');
		});
