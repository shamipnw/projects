  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1><i class="ace-icon fa fa-home home-icon"></i> Statements <small> <i class="ace-icon fa fa-angle-double-right"></i>Purchase Requests </small> </h1>
      </div>
      <!-- /.page-header -->
          ...
          <div   class="message-navbar2 clearfix">
            <div class="row">
              <div class="col-xs-12 col-md-12"  >
                <input name="purchase_statement" value="Mini Statement" type="radio" class="ace input-lg" />
                <span class="lbl"> Mini Statement</span> 
			</div>
			</div>
			...
			<div class="row padformSelect3">
               <div class="col-xs-12 col-md-2 padformSelect2"  >
                ...
                <input name="purchase_statement" value="Select Period" type="radio" class="ace input-lg" />
                <span class="lbl"> Detailed Statement</span> </div>
      ...
      <div class="widget-box">
        <div class="widget-header">
          <h4 class="widget-title">Statement Detail</h4>
        </div>
            ...
            <div class="content">
              <table width="100%" class="table table-striped table-bordered table-hover" id="simple-table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>SIP</td>
                    <td>5000</td>
                    <td>17/01/2016 - untill canclled</td>
                    <td>NEFT</td>
                  </tr>
                </tbody>
              </table>
              <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9">
                  <button class="btn btn-info btn-sm" type="button"> <i class="ace-icon fa fa-file-pdf-o bigger-110"></i>Save PDF </button>
                  &nbsp; &nbsp; &nbsp;
                  <button class="btn  btn-sm" type="button"> <i class="fa fa-file-excel-o"></i> Save as Excel </button>
                </div>
              </div>
            </div>
          </div>
