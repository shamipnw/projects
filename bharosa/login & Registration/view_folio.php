  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      <div class="page-header">
        <h1> Folio <small> <i class="ace-icon fa fa-angle-double-right"></i>View Transaction for Folio </small> </h1>
      </div>
      <!-- /.page-header -->
      ...
      <div class="row">
        <div class="col-xs-12">
          <div   class="message-navbar2 clearfix">
            <div class="row">
              <div class="col-xs-12 col-md-5 schemeselectbox"  > <span class="lbl schemeName"> Scheme Name</span>
                <select class="input-medium width-50 schemeheight" id="schemeName" name="schemeName">
                  <option value="">Select  Scheme Name</option>
                  <option value="">Scheme 1</option>
                  <option value="">Scheme 2</option>
                  <option value="">Scheme 3</option>
                  <option value="">Scheme 4</option>
                  <option value="">Scheme 5</option>
                </select>
              </div>
              ...
              <div class="col-xs-12 col-md-3 padform">
                <button class="btn btn-info btn-view2" type="button"> <i class="ace-icon fa fa-check bigger-110"></i> Get </button>
                <button class="btn btn-info btn-view2" type="reset"> <i class="ace-icon fa fa-undo bigger-110"></i> Reset </button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="content">
            ...
            <h3 class="lighter block green">Folio No : 123456789</h3>
              ...
              <div class="clearfix form-actions">
                <div class="col-md-offset-3 col-md-9"> <a class="btn btn-info btn-sm"  href="#modal_transaction"   data-toggle="modal"> <i class="ace-icon fa fa-file-pdf-o bigger-110"></i>Add Transactions</a> </div>
              </div>
            </div>
    </div>
    <!-- /.row --> 
